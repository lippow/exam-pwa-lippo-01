        ...
        <div className={cx('product-label', className)}>
            ...
            <Show when={!IS_OOS && config.enable && config.new.enable && showLabelNew}>
                <Badge
                    bold
                    success
                    className={cx('product-label-new uppercase !bg-green-50 !text-green-700', classNameBadge)}
            ...
            <Show when={!IS_OOS && config.enable && config.sale.enable && showSale}>
                <Badge
                    bold
                    className={cx('product-label-sale !bg-red-50 text-red-500 uppercase', showLabelNew && 'mt-[4px]', classNameBadge)}
